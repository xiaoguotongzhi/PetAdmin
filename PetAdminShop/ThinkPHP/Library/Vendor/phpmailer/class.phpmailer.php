...
class PHPMailer
{
  ...
  {       
       ...
       $this->SMTPSecure = 'ssl';
       $this->SMTPAuth = true;
       $this->Username = "notice_service@abwuliu.com"; 
       $this->Password = "Dywl@2016";
       $this->setFrom('notice_service@abwuliu.com', '第一物流系统通知'); 
       $this->addReplyTo('notice_service@abwuliu.com', '第一物流系统通知'); 
  } 
