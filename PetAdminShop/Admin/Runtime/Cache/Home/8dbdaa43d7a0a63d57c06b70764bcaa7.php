                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/AdminUser/PositionIdInfo/id/<?php echo ($vo["r_id"]); ?>" title="修改">
                                        <i class="fa fa-edit "></i>
                                    </a>
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="ActionDele(<?php echo ($vo["r_id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
...
<script>
    function ActionDele(ID) {
        ...
        mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
            $.get(
                    "/admin.php/Home/AdminUser/PositionIdDelete/id/"+ID,
