...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>新增职位</li>
            </ol>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2><i class="fa fa-indent red"></i><strong>新增职位</strong></h2>
            </div>
            <div class="panel-body">
                <form action="<?php echo U('AdminUser/AddPosition');?>" method="post" class="form-horizontal" onsubmit="return sub();">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" id="PositionName" name="PositionName" class="form-control" placeholder="请输入职位名称">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="checkbox">
                                    <label for="PositionArr[]">
                                        <input type="checkbox" id="PositionArr[]" name="PositionArr[]" value="<?php echo ($v["j_id"]); ?>"> <?php echo ($v["jurisdiction_name"]); ?>
                                    </label>
    ...
    <script>
        function sub() {
            ...
            if($("input:checkbox[name='PositionArr[]']:checked").length <= 0){
