    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>闪屏详情</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading" data-original-title>
                    <h2><i class="fa fa-picture-o red"></i><strong>闪屏详情</strong></h2>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><div style="margin-bottom:10px" class="col-md-4">
                                <a href="javascript:void(0);"  onclick="ScreenDel(<?php echo ($vo["id"]); ?>)"><i class="fa fa-trash-o"></i></a>
                                <img class="img-thumbnail" src="<?php echo ($vo["img"]); ?>" alt="Sample Image">
    ...
    <script>
        function ScreenDel(ID) {
            ...
            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get("/admin.php/Home/Homepage/ScreenIdDel/id/" + ID,
