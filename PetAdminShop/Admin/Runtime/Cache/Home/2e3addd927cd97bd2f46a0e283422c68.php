    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>审核回收站</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-table red"></i><span class="break"></span><strong>审核回收站</strong></h2>
                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td title="<?php echo ($vo["content"]); ?>">
                                    <?php
 if(strlen($vo['content'])>=20){ echo mb_substr($vo['content'],0,20,'utf-8').'...'; }else{ echo $vo['content']; } ?>
                                </td>
                                <td>
                                    <?php if($vo["reward_status"] == 1): ?><span class="label label-default">未奖励</span>
                                        <?php elseif($vo["reward_status"] == 2): ?><span class="label label-success">已奖励</span>
                                        <?php elseif($vo["reward_status"] == 3): ?><span class="label label-danger">不奖励</span><?php endif; ?>
                                </td>
                                <td>
                                    <?php if($vo["content_status"] == 1): ?><span class="label label-warning">通过</span>
                                        <?php else: ?><span class="label label-warning">未通过</span><?php endif; ?>
                                </td>
                                <td>
                                    <?php echo ($vo["share_num"]); ?>
                                </td>
                                <td>
                                    <!--<a class="btn btn-success" href="javascript:void(0);" title="通过" onclick="EBok(<?php echo ($vo["id"]); ?>)">-->
                                        <!--<i class="fa fa-thumbs-o-up "></i>-->
                                    <!--</a>-->
                                    <!--&nbsp;&nbsp;&nbsp;&nbsp;-->
                                    <!--<a class="btn btn-info" href="javascript:void(0);" title="拒绝" onclick="EBno(<?php echo ($vo["id"]); ?>,<?php echo ($vo["author_id"]); ?>)">-->
                                        <!--<i class="fa fa-thumbs-o-down "></i>-->
                                    <!--</a>-->
                                    <!--&nbsp;&nbsp;&nbsp;&nbsp;-->
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="EBde(<?php echo ($vo["id"]); ?>);">
                                    <i class="fa fa-trash-o "></i>
                                    </a>
                                </td>
...
<script>
        ...
        function EBde(Id) {
            ...
            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get("/admin.php/Home/Encyclopedias/EBde/id/" + Id,
