...
<head>
    ...
    <script>
        ...
        $.ajax({
            type:"get",
            url:"/admin.php/Home/Help/MenuLists",
            dataType:"json",
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>帮助与反馈详情</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-table red"></i><span class="break"></span><strong>帮助与反馈详情</strong></h2>
                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td title="<?php echo ($vo["proposal"]); ?>">
                                    <?php
 if(strlen($vo['proposal'])>=20){ echo mb_substr($vo['proposal'],0,20,'utf-8').'...'; }else{ echo $vo['proposal']; } ?>
                                </td>
                                <td><img class="img-thumbnail" src="<?php echo ($vo["img"]); ?>" alt="Sample Image" width="80px" height="80px;"></td>
                                <td><?php echo ($vo["username"]); ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$vo['create_time']);?></td>
                                <td>
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="HelpIdDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
    ...
    <script>
        function HelpIdDel(ID) {
            if(confirm("您确定要删除吗？")) {
                $.get("/admin.php/Home/Help/HelpIdDel/id/" + ID,
...
<script>
    function logout() {
        ...
        mizhu.confirm('温馨提醒', '确定要退出吗？', function() {
            $.get("/admin.php/Home/Help/LogOut",
                    function(data,status){
                        if(status=='success'){
                            location.href = '/admin.php/Home/Help/index';
                        }else{
