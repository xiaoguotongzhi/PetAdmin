    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="/admin.php/Home/PetCate/SaveNewCate" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <br><br>
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" id="cate_name" name="cate_name" class="form-control" value="<?php echo ($data["cate_name"]); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="radio-inline" for="inline-radio1">
                                <input type="radio" id="inline-radio1" name="variety_id" value="1" <?php if($data['variety_id']==1){ echo "checked";}?>> 狗
                            </label>
                            <label class="radio-inline" for="inline-radio2">
                                <input type="radio" id="inline-radio2" name="variety_id" value="2" <?php if($data['variety_id']==2){ echo "checked";}?>> 猫
                            </label>
                            <label class="radio-inline" for="inline-radio3">
                                <input type="radio" id="inline-radio3" name="variety_id" value="3" <?php if($data['variety_id']==3){ echo "checked";}?>> 鼠
                            </label>
                            <label class="radio-inline" for="inline-radio4">
                                <input type="radio" id="inline-radio4" name="variety_id" value="4" <?php if($data['variety_id']==4){ echo "checked";}?>> 其它
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="alias_name" name="alias_name" class="form-control" value="<?php echo ($data["alias_name"]); ?>">
                            <!--<span class="help-block">This is a help text</span>-->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="alias_jx" name="alias_jx" class="form-control" value="<?php echo ($data["alias_jx"]); ?>">
                            <!--<span class="help-block">This is a help text</span>-->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="py" name="py" class="form-control" value="<?php echo ($data["py"]); ?>">
                            <!--<span class="help-block">This is a help text</span>-->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="jx" name="jx" class="form-control" value="<?php echo ($data["jx"]); ?>">
                            <!--<span class="help-block">This is a help text</span>-->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="aleph" name="aleph" class="form-control" value="<?php echo ($data["aleph"]); ?>">
                            <!--<span class="help-block">This is a help text</span>-->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <img class="img-thumbnail" src="<?php echo ($data["hot_pic"]); ?>" alt="加载失败" height="200px;" width="200px;">
                            <hr>
