...
<div class="main">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" class="form-horizontal " action="/admin.php/Home/Question/EditQuestionIdInfo" onsubmit="return QuestionSub();" method="post">
                        <br><br>
    ...
    <script>
        ...
        function QuestionSub() {
            ...
            /*$.post("/admin.php/Home/Question/EditQuestionIdInfo",
                {
                    id:id,
                    question:question,
                    top:top,
