...
<div class="main">
            ...
            <div class="panel-body">
                <form class="form-horizontal ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <p class="form-control-static"><?php echo ($data["problem"]); ?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">举报内容</label>
                        <div class="col-md-9">
                            <p class="form-control-static"><?php echo ($data["report_content"]); ?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">预留邮箱</label>
                        <div class="col-md-9">
                            <p class="form-control-static" id="email"><?php echo ($data["email"]); ?></p>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script>
        $("#emailSub").click(function () {
            ...
            $.post("/admin.php/Home/Question/EmailToUser",
                {
                    report_id:report_id,
                    email:email,
                    title:title,
