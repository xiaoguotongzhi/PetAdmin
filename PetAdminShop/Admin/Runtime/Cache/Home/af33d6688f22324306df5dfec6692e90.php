    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>新增闪屏</li>
            </ol>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2><i class="fa fa-indent red"></i><strong>新增闪屏</strong></h2>
            </div>
            <div class="panel-body">
                <br><br>
                <form action="/admin.php/Home/Homepage/AddNewScreen" method="post" enctype="multipart/form-data" class="form-horizontal ">
                    <div class="form-group">
                        <label class="col-md-3 control-label">闪屏图片</label>
                        <div class="col-md-9">
