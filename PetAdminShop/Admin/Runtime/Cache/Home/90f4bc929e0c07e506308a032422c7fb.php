...
<div class="main">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-table red"></i><span class="break"></span><strong>常见问题详情</strong></h2>
 ...
 if(strlen($vo['content'])>=20){ echo mb_substr($vo['content'],0,20,'utf-8').'...'; }else{ echo $vo['content']; } ?>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info" href="/admin.php/Home/Help/EditProblemIdInfo/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <i class="fa fa-edit "></i>
                                    </a>

                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="ProblemIdDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
    ...
    <script>
        function ProblemIdDel(ID) {

            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get("/admin.php/Home/Help/ProblemIdDel/id/" + ID,
