                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <img class="img-thumbnail" src="<?php echo ($vo["img"]); ?>" alt="Sample Image" width="120px" height="80px;">
                                </td>
                                <td><?php echo ($vo["jid"]); ?></td>
                                <td>
                                    <?php if($vo["status"] == 1): ?><span class="label label-success">显示</span>
                                        <?php else: ?> <span class="label label-default">不显示</span><?php endif; ?>
                                </td>
                                <td><?php echo date('Y-m-d H:i:s',$vo['create_time']);?></td>
                                <td><?php echo ($vo["title"]); ?></td>
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/Journalism/EditJournalismBannerIdInfo/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <i class="fa fa-edit "></i>
                                    </a>
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="JBannerDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
...
<script>
    function JBannerDel(ID) {
        ...
        mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
            $.get("/admin.php/Home/Journalism/JournalismBDel/id/" + ID,
