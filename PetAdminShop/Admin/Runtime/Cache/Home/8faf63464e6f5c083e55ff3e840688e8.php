    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="/admin.php/Home/Journalism/JournalismBannerSub" method="post" enctype="multipart/form-data" class="form-horizontal " onsubmit="return JournalismBannerSub()">
                    <br><br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="text" id="jid" name="jid" class="form-control" placeholder="趣闻ID">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" id="title" name="title" class="form-control" placeholder="请输入广告语">
...
<script>
    function JournalismBannerSub() {
        var jid = $.trim($("#jid").val());
        var title = $.trim($("#title").val());
        if(jid.length<=0){
            $("#tip").empty();
            $("#tip").append('<div class="alert alert-danger"> <button type="button" class="close" data-dismiss="alert">×</button> <strong>Error!</strong>趣闻ID不能为空</div>');
            return false;
        }

        if(title.length<=0){
            $("#tip").empty();
            $("#tip").append('<div class="alert alert-danger"> <button type="button" class="close" data-dismiss="alert">×</button> <strong>Error!</strong>广告语不能为空</div>');
            return false;
        }
    }
</script>
