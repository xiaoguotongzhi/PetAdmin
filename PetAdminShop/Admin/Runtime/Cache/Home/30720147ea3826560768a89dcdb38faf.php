                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <input type="text" id="<?php echo ($vo["id"]); ?>" name="<?php echo ($vo["id"]); ?>" class="form-control" value="<?php echo ($vo["edition"]); ?>" size="12" onblur="BlueSave('<?php echo ($vo["edition"]); ?>,<?php echo ($vo["id"]); ?>,'+$(this).attr('name'));">
                                    <!--onblur="BlueSave(<?php echo ($vo["edition"]); ?>,<?php echo ($vo["id"]); ?>,$(this).attr('id'))"-->
                                </td>
                                <td><?php echo ($vo["upgrade_file"]); ?></td>
                                <td>
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="BlueDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
                                    </a>
                                </td>
    ...
    <script>
        function BlueSave(val) {
            ...
            if(OldEdition!=new_edition){
                $.get("/admin.php/Home/BluetoothUpgrade/BluetoothInfoEdit/id/"+Id+"/NewEdition/"+new_edition,
        ...
        function BlueDel(Id) {
            ...
            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get("/admin.php/Home/BluetoothUpgrade/BlueIdDel/id/" + Id,
                        function (data, status) {
                            history.go(0);
                        }
                );
