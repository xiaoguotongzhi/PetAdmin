...
<div class="main">
 ...
 if(strlen($vo['html_url'])>=20){ echo mb_substr($vo['html_url'],0,20,'utf-8').'...'; }else{ echo $vo['html_url']; } ?>
                                ...
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/Orders/EditBannerIdInfo/id/<?php echo ($vo["id"]); ?>" title="修改">
    ...
    <script>
        function OrderSave(OldOrder,ID,AttrId) {
            ...
            if(OldOrder!=banner_order){
                $.get("/admin.php/Home/Orders/AdminOrderSave/banner_order/"+banner_order+"/id/"+ID,
        ...
        function BannerDel(ID) {
            ...
            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get("/admin.php/Home/Orders/BannerIdDel/id/" + ID,
                        function (data, status) {
                            if (status == 'success') {
