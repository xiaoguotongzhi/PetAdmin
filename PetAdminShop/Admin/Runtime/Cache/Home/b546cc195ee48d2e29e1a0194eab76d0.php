                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/AdminUser/EditAdminUserInfo/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <i class="fa fa-edit "></i>
                                    </a>
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="ActionDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
                                    </a>
                                    <a class="btn btn-success" href="javascript:void(0);" title="密码重置" onclick="PassReset(<?php echo ($vo["id"]); ?>);">
...
<script>
    function ActionDel(UserId) {
        ...
        mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
            $.get(
                    "/admin.php/Home/AdminUser/RoleIdDel/UserId/"+UserId,
    ...
    function PassReset(UserId) {
        ...
        mizhu.confirm('温馨提醒', '您确定要进行密码重置吗？', function() {
            $.get(
                    "/admin.php/Home/AdminUser/AdminUserIdPassReset/UserId/"+UserId,
                    function(data,status){
                        if(status=='success'){
                            if(data.code==200){
                                mizhu.toast(data.msg);
