...
<head>
    ...
    <script>
        ...
        $.ajax({
            type:"get",
            url:"/admin.php/Home/BluetoothUpgrade/MenuLists",
            dataType:"json",
            success:function(data){
                //console.log(data);
                $.each(data.data, function(i,val){
                    //循环一级菜单
                    $("#menu2").append('<li> <a href="'+val.jurisdiction_url+'" onclick="showUl(this)" style="display: block"><i class="fa fa-trophy"></i><span class="text">'+val.jurisdiction_name+'</span><span class="fa fa-angle-down pull-right"></span></a> <ul class="nav sub" id='+val.j_id+'> </ul></li>')
...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>新增版本文件</li>
            </ol>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2><i class="fa fa-indent red"></i><strong>新增版本文件</strong></h2>
            </div>
            <div class="panel-body">
                <form action="/admin.php/Home/BluetoothUpgrade/BluetoothUpgradeSub" method="post" enctype="multipart/form-data" class="form-horizontal " onsubmit="return BluetoothSub();">
                    <br><br>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="edition">版本号</label>
                        <div class="col-md-2">
                            <input type="text" id="edition" name="edition" class="form-control" placeholder="请输入版本号">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
                        <label class="col-md-3 control-label">版本文件</label>
                        <div class="col-md-9">
                            ...
                            <div class="fileInput left" style="width:102px;height:34px; background:url(/Public/Images/upFileBtn.png);overflow:hidden;position:relative;">
                                <input type="file" name="upgrade_file" id="upfile" class="upfile" onchange="document.getElementById('upfileResult').innerHTML=this.value" style="position:absolute;top:-100px;"/>
    ...
    <script>
        function BluetoothSub() {
            var edition = $.trim($("#edition").val());
            if(edition.length<=0){
                $("#tip").append('<div class="alert alert-danger"> <button type="button" class="close" data-dismiss="alert">×</button> <strong>Error!</strong> 版本号不能为空!</div>');
                return false;
            }
            return true;
        }
...
<script>
    function logout() {
        ...
        mizhu.confirm('温馨提醒', '确定要退出吗？', function() {
            $.get("/admin.php/Home/BluetoothUpgrade/LogOut",
                    function(data,status){
                        if(status=='success'){
                            location.href = '/admin.php/Home/BluetoothUpgrade/index';
                        }else{
