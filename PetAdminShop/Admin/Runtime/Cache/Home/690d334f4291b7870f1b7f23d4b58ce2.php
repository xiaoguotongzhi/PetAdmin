...
<div class="main">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2><i class="fa fa-indent red"></i><strong>广告详情</strong></h2>
            </div>
            <div class="panel-body">
                ...
                <form class="form-horizontal ">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <img class="img-thumbnail" src="<?php echo ($data["img"]); ?>" width="250px" height="200px">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="hidden" id="banner_id" name="banner_id" value="<?php echo ($data["id"]); ?>">
                            <input type="text" id="html_url" name="html_url" class="form-control" value="<?php echo ($data["html_url"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="radio-inline">
                                <input type="radio" name="status" value="1" <?php if($data['status']=='1'){ echo 'checked';}?>> 正常显示
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="status" value="2" <?php if($data['status']=='2'){ echo 'checked';}?>> 不显示
                            </label>
                        </div>
                    </div>
                    <br>
                    <div style="margin-left: 21%">
                        <button type="button" class="btn btn-sm btn-success" id="BannerSub"><i class="fa fa-dot-circle-o"></i> 提交</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script>
        $("#BannerSub").click(function () {
            var id = $("#banner_id").val();
            var url = $("#html_url").val();
            var status = $("input[name='status']:checked").val();

            $.post("/admin.php/Home/Homepage/EditBanner",
                    {
                        id:id,
                        url:url,
                        status:status
