        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="form-group" style="margin: 15px 0px;">
                    <div class="col-md-3">
                        <form action="/admin.php/Home/PetCate/PetCateSearchWord" method="get" onsubmit="return SubSearch()">
                            <div class="input-group">


                                <?php if($word == null): ?><input type="text" id="word" name="word" class="form-control" placeholder="请输入关键字"><span class="input-group-btn">
                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <img class="img-thumbnail" src="<?php echo ($vo["hot_pic"]); ?>" alt="加载失败" width="80px" height="80px;">
                                </td>
                                <td><?php echo ($vo["cate_name"]); ?></td>
                                <td>
                                    <?php if($vo["variety_id"] == 1): ?>狗
                                        <?php elseif($vo["variety_id"] == 2): ?> 猫
                                        <?php elseif($vo["variety_id"] == 3): ?> 鼠
                                        <?php else: ?> 其它<?php endif; ?>
                                </td>
                                <td><?php echo ($vo["alias_name"]); ?></td>
                                <td><?php echo ($vo["alias_jx"]); ?></td>
                                <td><?php echo ($vo["py"]); ?></td>
                                <td><?php echo ($vo["jx"]); ?></td>
                                <td><?php echo ($vo["aleph"]); ?></td>
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/PetCate/PetCateIdInfo/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <i class="fa fa-edit "></i>
                                    </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="PetCateDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
                                    </a>
                                </td>
    ...
    <script>
        ...
        function PetCateDel(Id){
            ...
            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get("/admin.php/Home/PetCate/PetCateDel/id/" + Id,
