...
//                    $("#DIV的ID值").append('<div class="fui-according-header"><span class="left">'+data.ordersn+'<br><span>'+data.createtime+'</span></span><span class="right">'+data.commission+'<br><span>'+data.status+'</span></span><span class="remark" onclick="click()"></span></div>');
...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>新增趣闻</li>
            </ol>
        </div>
    </div>
    <div id="tip"></div>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2><i class="fa fa-indent red"></i><strong>新增趣闻</strong></h2>
            </div>
            <div class="panel-body">
                <form action="/admin.php/Home/Journalism/AddNewJournalism" method="post" enctype="multipart/form-data" class="form-horizontal ">
                    <br><br>
                    <div class="form-group">
                        <label class="col-md-3 control-label">标题：</label>
                        <div class="col-md-3">
                            <input type="text" id="title" name="title" class="form-control" placeholder="输入标题">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="editer" name="editer" class="form-control" placeholder="请输入编辑名称">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="视频"> 视频
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="科普"> 科普
                            </label>
                            <label class="checkbox-inline" >
                                <input type="checkbox" name="tag" value="搞笑">  搞笑
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="汪星人">  汪星人
                            </label>
                             <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="喵星人">   喵星人
                            </label>
                             <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="小宠">  小宠
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="大事件">  大事件
                            </label>
                             <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="生活">  生活
                            </label>
                             <label class="checkbox-inline" >
                                <input type="checkbox" name="tag" value="社会">  社会
                            </label>
                             <label class="checkbox-inline" >
                                <input type="checkbox" name="tag" value="名人">   名人
                            </label>
                             <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="感人">  感人
                            </label>
                             <label class="checkbox-inline">
                                <input type="checkbox" name="tag" value="另类">  另类
                            </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" id="froms" name="froms" class="form-control" placeholder="请输入文章来源">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="radio-inline" for="inline-radio1">
                                <input type="radio" id="inline-radio1" name="introduction" value="1" checked /> 单图
                            </label>
                            <label class="radio-inline" for="inline-radio2">
                                <input type="radio" id="inline-radio2" name="introduction" value="2"> 多图
                            </label>
                            <label class="radio-inline" for="inline-radio3">
                                <input type="radio" id="inline-radio3" name="introduction" value="3"> 视频
                            </label>
                            <label class="radio-inline" for="inline-radio4">
                                <input type="radio" id="inline-radio4" name="introduction" value="4"> 无图
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" id="video_url" name="video_url" class="form-control" placeholder="请输入视频地址(没有可不写)">
                        </div>
                    </div>
    ...
    <script>
        function JournalismSub() {
            ...
            if(froms.length<=0){
                $("#tip").empty();
                $("#tip").append('<div class="alert alert-danger"> <button type="button" class="close" data-dismiss="alert">×</button> <strong>Error!</strong> 请输入来源!</div>');
                return false;
            }

            //提交
            $.post("/admin.php/Home/Journalism/AddNewJournalism",
                    {
                        title:title,
                        author:author,
                        editer:editer,
