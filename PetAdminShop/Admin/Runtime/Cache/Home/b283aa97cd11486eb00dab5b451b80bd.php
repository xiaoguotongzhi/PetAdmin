                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <?php
 if(strlen($vo['report_content'])>=6){ echo mb_substr($vo['report_content'],0,6,'utf-8').'...'; }else{ echo $vo['report_content']; } ?>
                                </td>
                                <td><?php echo ($vo["email"]); ?></td>
                                <td><?php echo date('Y-m-d H:i:s',$vo['create_time']);?></td>
                                <td>
                                    <?php if($vo["status"] == 1): ?><span class="label label-success">已回复</span>
                                        <?php else: ?> <span class="label label-default">待回复</span><?php endif; ?>
                                </td>
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/Question/ReportEmailAnswer/id/<?php echo ($vo["id"]); ?>" title="邮箱回复">
                                        <i class="fa fa-envelope "></i>
                                    </a>
                                    <a class="btn btn-info" href='/admin.php/Home/Question/QuestionIdInfo/id/<?php echo ($vo["question_id"]); ?>' title="问答详情">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="ReportIdDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
    ...
    <script>
        function ReportIdDel(ID) {
            ...
            mizhu.confirm('温馨提醒', '您确定要删除吗？', function() {
                $.get(
                        "/admin.php/Home/Question/ReportIdDel/id/"+ID,
