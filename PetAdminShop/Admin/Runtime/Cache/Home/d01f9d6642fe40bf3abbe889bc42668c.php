    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>新增问答</li>
            </ol>
        </div>
    </div>
    <div id="tip"></div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-indent red"></i><strong>新增问答</strong></h2>
                </div>
                <div class="panel-body">
                    <form action="/admin.php/Home/Question/AddNewQuestion" method="post" enctype="multipart/form-data" class="form-horizontal " onsubmit="return QuestionSub();">
                        <br><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="question" name="question" class="form-control" placeholder="请输入问答题目">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="top">上</label>
                            <div class="col-md-3">
                                <input type="text" id="top" name="top" class="form-control" placeholder="答案一">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="down">下</label>
                            <div class="col-md-3">
                                <input type="text" id="down" name="down" class="form-control" placeholder="答案二">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="left">左</label>
                            <div class="col-md-3">
                                <input type="text" id="left" name="left" class="form-control" placeholder="答案三">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="right">右</label>
                            <div class="col-md-3">
                                <input type="text" id="right" name="right" class="form-control" placeholder="答案四">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="AnswerTrue">正确答案</label>
                            <div class="col-md-3">
                                <input type="text" id="AnswerTrue" name="AnswerTrue" class="form-control" value=""  readonly = "readonly">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="text" id="fraction" name="fraction" class="form-control">
                            </div>
                        </div>
                        <br>
