                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td>
                                    <?php if($vo["status"] == 1): ?><span class="label label-success">通过</span>
                                        <?php else: ?> <span class="label label-default">待审核</span><?php endif; ?>
                                </td>
                                <td>
                                    <a class="btn btn-info" href="javascript:void(0);" title="通过" onclick="QuestionAdopt(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-thumbs-o-up "></i>
                                    </a>
                                    <!--/admin.php/Home/Question/QuestionIdAdopt/id/<?php echo ($vo["id"]); ?><a class="btn btn-info" href="/admin.php/Home/Question/QuestionIdRefuse/id/<?php echo ($vo["id"]); ?>" title="拒绝">-->
                                        <!--<i class="fa fa-thumbs-o-down "></i>-->
                                    <!--</a>-->
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="QuestionExamineDel(<?php echo ($vo["id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
    ...
    <script>
        ...
        function QuestionAdopt(ID) {
            ...
            mizhu.confirm('温馨提醒', '确定要通过这条信息吗？', function() {
                $.get(
                        "/admin.php/Home/Question/QuestionIdAdopt/id/"+ID,
                        function(data,status){
                            if(status=='success'){
                                if(data.code==200){
                                    mizhu.toast(data.msg);
