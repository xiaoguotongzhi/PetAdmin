...
<div class="main">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <br><br>
                <form action="/admin.php/Home/Homepage/AddNewBanner" method="post" enctype="multipart/form-data" class="form-horizontal " onsubmit="return NewBannerSub();">
    ...
    <script>
        ...
        function OrderBlur() {
            ...
            $.get("/admin.php/Home/Homepage/OrderYz/banner_order/"+banner_order,
