        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data.data, function(i,val){
                    //循环一级菜单
                    $("#menu2").append('<li> <a href="'+val.jurisdiction_url+'" onclick="showUl(this)" style="display"><i class="fa fa-trophy"></i><span class="text">'+val.jurisdiction_name+'</span><span class="fa fa-angle-down"></span></a> <ul class="nav sub" id='+val.j_id+'> </ul></li>')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-location-arrow"></i>月排行</li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h2><i class="fa fa-spinner red"></i><strong>月排行(本月度共有<?php echo ($count); ?>位用户参与答题)</strong></h2>
                                    ...
                                    <div class="tab-pane active" id="tasks">
                                        <table class="table bootstrap-datatable datatable small-font">
                                            ...
                                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                                <td><?php echo ($vo["true_count"]); ?></td>
                                                <td><?php echo ($vo["username"]); ?></td>
                                                <td>
                                                    <div class="progress thin">
                                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo ($vo["true_count"]); ?>" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo ($vo["true_count"]); ?>%">
