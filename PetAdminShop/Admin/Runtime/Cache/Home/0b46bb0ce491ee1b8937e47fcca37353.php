                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php if(is_array($arr2)): foreach($arr2 as $key=>$v): ?><div class="checkbox">
                                    <label>
                                        <input type="checkbox"<?php
 foreach($arr as $kk=>$vv){ foreach($vv['role_name'] as $ko=>$vo){ if($vo==$v['role_name']){ echo "checked"; } } } ?>  name="checkbox" value="<?php echo ($v["r_id"]); ?>"> <?php echo ($v["role_name"]); ?>
                                    </label>
    ...
    <script>
        $("#sub").click(function () {
            ...
            $.post("/admin.php/Home/AdminUser/EditAdminUserInfoId",
                {
                    UserId:UserId,
