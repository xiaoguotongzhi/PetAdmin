            ...
            <div class="panel-body">
                <form class="form-horizontal ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <img class="img-thumbnail" src="<?php echo ($data["img"]); ?>" alt="Sample Image">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <input type="text" id="jid" name="jid" class="form-control" value="<?php echo ($data["jid"]); ?>">
                        </div>
                    </div>
                    <br>
                    <div class="form-group">
...
<script>
    function EditJournalismBannerInfo() {
        ...
        $.post("/admin.php/Home/Journalism/EditJournalismBannerInfo",
                {
                    id:id,
                    jid:jid,
                    title:title,
