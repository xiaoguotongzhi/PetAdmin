...
<div class="main">
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <br><br>
                <form action="/admin.php/Home/Orders/AddNewBanner" method="post" enctype="multipart/form-data" class="form-horizontal " onsubmit="return NewBannerSub();">
    ...
    <script>
        ...
        function OrderBlur() {
            ...
            $.get("/admin.php/Home/Orders/OrderYz/banner_order/"+banner_order,
