                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <tr>
                            ...
                            <td><?php echo ($data["goods_color"]); ?></td>
                            <td><?php echo ($data["goods_num"]); ?></td>
                            <td><?php echo ($data["goods_price"]); ?></td>
                            <td><?php echo ($data["goods_brand"]); ?></td>
                        </tr>
                        </tbody>
                        ...
                        <tr>
                            <th>所在区域</th>
                            <th colspan="4"><?php echo ($data["area"]); ?></th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            <th>详细地址</th>
                            <th colspan="4"><?php echo ($data["address"]); ?></th>
                        </tr>
                        </thead>
                        ...
                        <tbody>
                        <tr>
                            <td colspan="2"><?php echo ($data["goods_content"]); ?></td>
                            <td>
                                <?php
 if(empty($data['pay_time'])){ echo "未检测到信息"; }else{ echo date('Y:m:d H:i:s',$data['pay_time']); } ?>
                            </td>
                            <td>
                                <?php if($data["pay_status"] == 1): ?>微信
                                    <?php elseif($data["pay_status"] == 2): ?>支付宝
                                    <?php else: ?> ERROR<?php endif; ?></td>
                            <td>
                                <input type="hidden" name="status" id="status" value="<?php echo ($data["status"]); ?>">
                                <?php if($data["status"] == 1): ?>未付款
                                    <?php elseif($data["status"] == 2): ?>已付款
                                    <?php elseif($data["status"] == 3): ?>已发货
                                    <?php elseif($data["status"] == 4): ?>已收货
                                    <?php elseif($data["status"] == 9): ?>问题件
                        ...
                        <tr>
                            ...
                            <th colspan="4">
                                <?php
 if(empty($data['remarks'])){ echo "未检测到信息"; }else{ echo $data['remarks']; } ?>
                            </th>
                        </tr>
                        </thead>
                    ...
                    <?php if($data["status"] == 3): ?><div>*您已发货：物流单号为：<span style="margin-left: 10px; font-size: 16px; color: red"><?php echo ($data["delivery_sn"]); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;快递公司代号为：<span style="margin-left: 10px; font-size: 16px; color: red"><?php echo ($data["com"]); ?></span></div>
                        <?php else: ?> <form class="form-horizontal ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="hidden" name="orders_id" id="orders_id" value="<?php echo ($data["orders_id"]); ?>">
    ...
    <script>
        ...
        function DeliverGoods() {
            ...
            var com = $.trim($("#com").val());
                ...
                $.post("/admin.php/Home/Orders/SendGoods",
                    {
                        id:orders_id,
