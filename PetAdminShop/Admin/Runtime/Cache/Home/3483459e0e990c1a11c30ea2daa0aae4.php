                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                ...
                                <td><?php echo ($vo["merchant_type"]); ?></td>
                                <td><?php echo ($vo["scope"]); ?></td>
                                <td><?php echo ($vo["shopkeeper"]); ?></td>
                                <td><?php echo ($vo["phone"]); ?></td>
                                <td><?php echo ($vo["tel"]); ?></td>
                                <td>
                                    <?php if($vo["status"] == 1): ?><span class="label label-default">待审核</span>
                                        <?php elseif($vo["status"] == 2): ?> <span class="label label-success">通过</span>
                                        <?php elseif($vo["status"] == 3): ?> <span class="label label-danger">未通过</span><?php endif; ?>
                                </td>
                                <td>
                                    <a class="btn btn-info" href="/admin.php/Home/Orders/ShopIdInfo/s_id/<?php echo ($vo["s_id"]); ?>" title="详情">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <!--/admin.php/Home/Orders/QuestionIdAdopt/id/<?php echo ($vo["id"]); ?><a class="btn btn-info" href="/admin.php/Home/Orders/QuestionIdRefuse/id/<?php echo ($vo["id"]); ?>" title="拒绝">-->
                                    <!--<i class="fa fa-thumbs-o-down "></i>-->
                                    <!--</a>-->
                                    <a class="btn btn-danger" href="javascript:void(0);" title="删除" onclick="ShopExamineDel(<?php echo ($vo["s_id"]); ?>);">
                                        <i class="fa fa-trash-o "></i>
    ...
    <script>
        function ShopExamineDel(ID) {
            mizhu.confirm('温馨提醒', '确定要删除吗？', function() {
                $.get(
                        "/admin.php/Home/Orders/ShopExamineDel/s_id/"+ID,
        ...
        function QuestionAdopt(ID) {
            ...
            mizhu.confirm('温馨提醒', '确定要通过这条信息吗？', function() {
                $.get(
                        "/admin.php/Home/Orders/QuestionIdAdopt/id/"+ID,
                        function(data,status){
                            if(status=='success'){
                                if(data.code==200){
                                    mizhu.toast(data.msg);
