...
<head>
    ...
    <script>
        ...
        $.ajax({
            type:"get",
            url:"/admin.php/Home/Sms/MenuLists",
            dataType:"json",
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-trophy"></i>短信管理</li>
                <li><i class="fa fa-location-arrow"></i>短信统计</li>
            </ol>
        </div>
    </div>
...
<script>
    function logout() {
        ...
        mizhu.confirm('温馨提醒', '确定要退出吗？', function() {
            $.get("/admin.php/Home/Sms/LogOut",
                    function(data,status){
                        if(status=='success'){
                            location.href = '/admin.php/Home/Sms/index';
                        }else{
