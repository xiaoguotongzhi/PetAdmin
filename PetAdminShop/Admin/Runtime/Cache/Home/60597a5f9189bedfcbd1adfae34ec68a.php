    ...
    <div class="container-fluid" style="background:#181c20;">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown visible-md visible-lg">
                ...
                <ul class="dropdown-menu">
                    <li><a href="page-profile.html"><i class="fa fa-user"></i>个人中心</a></li>
...
<div class="main">
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <textarea id="content" name="content" rows="9" class="form-control"><?php echo ($data["content"]); ?></textarea>
                        </div>
                    </div>
                    <br>
    ...
    <script>
        function SaveProblemSub() {
            ...
            $.post("/admin.php/Home/Help/SaveProblemSub",
                    {
                        id:id,
                        title:title,
                        content:content
